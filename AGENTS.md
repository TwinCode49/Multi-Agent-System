...
## Language Standard
- **AI-facing files** (SKILL.md, agent.md, .agent.md, this file, opencode.json): written in **English**. Follow English conventions for frontmatter, descriptions, and instructions.
